    ...
    <div className="min-h-screen p-8 bg-gradient-to-br from-pink-50 via-purple-50 to-blue-50 dark:from-purple-900 dark:via-blue-900/20 dark:to-pink-900">
      ...
      <div className="fixed bottom-8 right-8 flex gap-4">
        <button
          ...
          className="bg-gradient-to-r from-pink-500 to-purple-500 hover:from-pink-600 hover:to-purple-600 text-white p-4 rounded-full shadow-xl hover:translate-y-[-5px] hover:shadow-2xl transition-all duration-300 group animate-bounce"
        >
